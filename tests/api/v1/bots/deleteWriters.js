...
/**
 * tests/api/v1/bots/deleteWriters.js
 */
'use strict';
...
const path = '/v1/bots/{key}/writers';
const writerPath = '/v1/bots/{key}/writers/{userNameOrId}';

describe('tests/api/v1/bots/deleteWriters.js >', () => {
  let token;
  let otherValidToken;
  let coll;
  let user;
  ...
  describe('delete writer(s) >', () => {
    ...
    it('return 403 when deleting writers using a token generated for ' +
